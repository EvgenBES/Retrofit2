...
import com.example.fox.myapplication.R;
import com.example.fox.myapplication.retrofitApi.MainActivity;
...
public class ActivityMain extends AppCompatActivity implements CredentialsDialog.ICredentialsDialogListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        repositoriesSpinner.setAdapter(new ArrayAdapter<>(ActivityMain.this, android.R.layout.simple_spinner_dropdown_item, new String[]{"No repositories available"}));
        ...
        issuesSpinner.setAdapter(new ArrayAdapter<>(ActivityMain.this, android.R.layout.simple_spinner_dropdown_item, new String[]{"Please select repository"}));
        ...
        switch (view.getId()) {
            ...
            case R.id.send_comment_button:
                ...
                if (!newComment.isEmpty()) {
                    ...
                    Toast.makeText(ActivityMain.this, "Please enter a comment", Toast.LENGTH_LONG).show();
                }
                break;
        }
    }
    ...
    private DisposableSingleObserver<List<GithubRepo>> getRepositoriesObserver() {
        return new DisposableSingleObserver<List<GithubRepo>>() {
            ...
            public void onSuccess(List<GithubRepo> value) {
                if (!value.isEmpty()) {
                    ArrayAdapter<GithubRepo> spinnerAdapter = new ArrayAdapter<>(ActivityMain.this, android.R.layout.simple_spinner_dropdown_item, value);
                    repositoriesSpinner.setAdapter(spinnerAdapter);
                    repositoriesSpinner.setEnabled(true);
                } else {
                    ArrayAdapter<String> spinnerAdapter = new ArrayAdapter<>(ActivityMain.this, android.R.layout.simple_spinner_dropdown_item, new String[]{"User has no repositories"});
                    repositoriesSpinner.setAdapter(spinnerAdapter);
                    repositoriesSpinner.setEnabled(false);
                }
            }
            ...
            public void onError(Throwable e) {
                e.printStackTrace();
                Toast.makeText(ActivityMain.this, "Can not load repositories", Toast.LENGTH_SHORT).show();
    ...
    private DisposableSingleObserver<List<GithubIssue>> getIssuesObserver() {
        return new DisposableSingleObserver<List<GithubIssue>>() {
            ...
            public void onSuccess(List<GithubIssue> value) {
                if (!value.isEmpty()) {
                    ArrayAdapter<GithubIssue> spinnerAdapter = new ArrayAdapter<>(ActivityMain.this, android.R.layout.simple_spinner_dropdown_item, value);
                    issuesSpinner.setEnabled(true);
                    commentEditText.setEnabled(true);
                    sendButton.setEnabled(true);
                    issuesSpinner.setAdapter(spinnerAdapter);
                } else {
                    ArrayAdapter<String> spinnerAdapter = new ArrayAdapter<>(ActivityMain.this, android.R.layout.simple_spinner_dropdown_item, new String[]{"Repository has no issues"});
                    issuesSpinner.setEnabled(false);
            ...
            public void onError(Throwable e) {
                e.printStackTrace();
                Toast.makeText(ActivityMain.this, "Can not load issues", Toast.LENGTH_SHORT).show();
            }
        };
    }
    ...
    private DisposableSingleObserver<ResponseBody> getCommentObserver() {
        return new DisposableSingleObserver<ResponseBody>() {
            ...
            public void onSuccess(ResponseBody value) {
                ...
                Toast.makeText(ActivityMain.this, "Comment created", Toast.LENGTH_LONG).show();
            }

            @Override
            public void onError(Throwable e) {
                e.printStackTrace();
                Toast.makeText(ActivityMain.this, "Can not create comment", Toast.LENGTH_SHORT).show();
            }
        };
    }
